...
- `/pulse-ambassador-users [member] [days] [limit] [page]` — list users invited by an ambassador with current/left membership status (member is required). Response also includes ambassador invite-code list with current uses and supports pagination.
